...
function HrmCaseStudy() {
  // const { data } = useFetchData("hrm");

  // if (!data.length) {
  //   return <div style={{ marginTop: "100px" }}>Loading...</div>;
  // }
  // const data = apiCaseStudy("hrm");
  ...
  const { dataState: data, loading } = useFetchCaseStudyData("hrm");
